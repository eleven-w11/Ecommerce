            ...
            <main className="admin-main">
                ...
                <div className="quick-actions-section">
                    ...
                    <div className="quick-actions-grid">
                        <Link to="/AdminProducts" className="quick-action-card" data-testid="admin-products-link">
                        ...
                        <Link to="/AdminOrders" className="quick-action-card" data-testid="admin-orders-link">
                            <div className="action-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        <Link to="/AdminUsers" className="quick-action-card" data-testid="admin-users-link">
                            <div className="action-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                                    <circle cx="9" cy="7" r="4"></circle>
                        ...
                        <Link to="/AdminVisitors" className="quick-action-card" data-testid="admin-visitors-link">
                            <div className="action-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        <Link to="/UserList" className="quick-action-card" data-testid="admin-messages-link">
                            <div className="action-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                                </svg>
